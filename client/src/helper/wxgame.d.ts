...
declare const wx: {
    ...
    updateShareMenu(object: { withShareTicket?: boolean, isUpdatableMessage?: boolean, activityId?: string, templateInfo?: Object, success?: (res: any) => void, fail?: (res: any) => void, complete?: (res: any) => void }): void;
     ...
     *
     */
    openCustomerServiceConversation(object: { sessionFrom?: string, showMessageCard?: boolean, sendMessageTitle?: string, sendMessagePath?: string, sendMessageImg?: string, success?: (res: any) => void, fail?: (res: any) => void, complete?: (res: any) => void }): void

    /**
     * 跳转到其他小游戏
     */
    navigateToMiniProgram(object: { appId: string, path?: string, extraData?: any, envVersion?: string, success?: (res) => void, fail?: (res) => void, complete?: () => void });
    ...
    loadSubpackage(param: object): LoadSubpackageTask;
}
